...
using CoolFitnessBackend.Services; // Ensure this is imported
...
namespace CoolFitnessBackend.Controllers
{
    ...
    public class PlanController : ControllerBase
    {
        ...
        [HttpPost("generate")]
        public IActionResult GeneratePlan([FromBody] CoolFitnessBackend.Services.UserPreferences preferences)
        {
            try
            {
                if (preferences == null ||
